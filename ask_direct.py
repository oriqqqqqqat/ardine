...
if __name__ == "__main__":
    questions = [
        ...
        "มี invite ไหนบ้างที่หมดอายุแล้วแต่ยังไม่มีคนกดรับ",
        "มีใครบ้างที่อยู่มากกว่าหนึ่งทีม แล้วในแต่ละทีมได้ role อะไรบ้าง",
        "ใครถูก assign งาน แต่ ไม่ใช่คนสร้าง task",
        "มีใครบ้างที่เป็น admin ในทีมหนึ่ง แต่ในอีกทีมเป็นแค่ member หรือ viewer",
        ...
        "task ไหนยัง active อยู่แต่ยังไม่มีคนรับผิดชอบ และ task นั้นอยู่ในโปรเจกต์ของลูกค้าคนไหน",
        "คนไหนบันทึกเวลาทำงานรวมมากที่สุดใน 30 วันที่ผ่านมา แล้วส่วนใหญ่ทำงานให้ลูกค้าคนไหน",
        "มี user คนไหนบ้างที่ใช้อีเมลลงท้ายด้วย @kmitl.ac.th",
        "นับจำนวนผู้ใช้ที่ใช้อีเมล kmitl.ac.th ให้หน่อย",
